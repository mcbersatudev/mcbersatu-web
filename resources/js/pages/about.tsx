...
import { SectionType, aboutSection } from '@/data/pages';
...
export default function About() {
    const [section1, section2, section3] = aboutSection as [SectionType, SectionType, SectionType];
        ...
        <AppLayout>
            ...
            <div className="font-opensans mb-40 flex min-h-screen w-full flex-col bg-[#F0F0F0] text-[#101010] dark:bg-[#F0F0F0]">
                ...
                >
                    <div className="flex w-full items-center gap-[50vh] pt-[40vh] lg:max-2xl:pt-[60vh]">
                        <div className="flex w-full items-center">
                            <h1 className="font-lato ml-[10%] w-[20%] text-left text-4xl font-black text-[#101010]">MENGAPA MINECRAFTER BERSATU?</h1>
                        </div>
                ...
                <section className="my-14 h-full w-full px-[5%]">
                    <div className="mx-auto block w-full items-start justify-center gap-12 md:w-[80%] lg:max-2xl:flex lg:max-2xl:w-full lg:max-2xl:justify-between">
                        <p className="my-0 w-auto text-justify text-sm font-normal whitespace-pre-line lg:max-2xl:w-[50%]">{section1.text}</p>

                        <p className="my-4 w-auto text-justify text-sm font-normal whitespace-pre-line lg:max-2xl:my-0 lg:max-2xl:w-[50%]">
                            {section2.text}
                        </p>
                    </div>

                    <div className="mx-auto mt-14 flex w-full flex-col justify-around gap-8 pt-14 md:w-[80%] lg:max-2xl:w-full lg:max-2xl:flex-row">
                        <h3 className="text-3xl font-bold">Tujuan</h3>
                        <p className="w-auto text-justify text-sm font-normal whitespace-pre-line lg:max-2xl:w-[50%]">{section3.text}</p>
                    </div>
                </section>
